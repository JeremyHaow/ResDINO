...
from models.dino_resnet import dino_resnet50
...
def get_args_parser():
    ...
    parser.add_argument('--project_name', type=str, default='SAFE_experiments', help='Swanlab project name')
    parser.add_argument('--run_name', type=str, default=None, help='Swanlab run name')
...
def main(args):
    ...
    if args.model == 'SAFE':
        ...
        model = dino_resnet50(num_classes=args.nb_classes, pretrained=args.pretrained)
    else:
        model = timm.create_model(args.model, pretrained=args.pretrained, num_classes=args.nb_classes)
    model.to(device)
